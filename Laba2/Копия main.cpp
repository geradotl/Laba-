...
//
//  Клас Cash для роботи з грошовими сумами. Сума повинна бути подана полями-номіналами банкнот і копійок (1, 2, 5, 10, 20, 50 100, 200, 500 гривень; 1, 2, 5, 10, 25, 50 копійок), значенням яких є кількість банкнот даного виду. Наприклад, сума в 135 грн 45 коп. –  банкнота в 100 грн. – 1, банкнота в 20 грн. – 1, банкнота в 10 грн. – 1, банкнота в 5 грн. – 1, 25 коп. – 1, 10 коп. – 2 (при визначенні номіналів банкнот виходимо з мінімізації їх кількості). Дробова частина під час виведення на екран повинна бути відділена від цілої комою. Реалізувати додавання, віднімання, ділення сум, ділення та множення суми на дробове число та операції порівняння.



//  Клас для банківського рахунку Account з полями: прізвище власника, номер рахунку, сума на рахунку, що подана як екземпляр класу відповідно до варіанту завдання, відсоток нарахування. Операції: відкриття рахунку, зняття суми, поповнення рахунку, нарахування відсотків, переведення суми в валюту за заданим курсом Х, отримати суму не в числовому, а в словесному відображенні (наприклад: 121,30 – сто двадцять одна гривня тридцять копійок).
